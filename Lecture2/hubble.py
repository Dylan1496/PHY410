...
#below are the speeds and distances for each nebula individually
# distances in Mpc
...
#below are the speeds and distances for the nine groups
#distances in Mpc
r = [0.033, 0.275, 0.483, 2.0, .715, 1.55, .9, .657, .6315]

#velocities in km/s
v = [+230, -202.5, +253.3, +810, +250, +730, +317.5, +185, +425]
# Plot v versus r
#plt.scatter(r,v)
